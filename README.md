...
`vertebrae` is a Python package for evaluating feature extractors and transfer-learning backbones on labeled datasets. It supports precomputed embeddings, scikit-learn pipelines, custom callable extractors, local PyTorch modules, and optional Hugging Face and sentence-transformers workflows.
...
Optional integrations are available through the `torch`, `onnx`, and `hf` extras:
